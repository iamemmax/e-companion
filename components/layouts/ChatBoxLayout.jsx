...
import Styles from "./styles/chatboxlayout.module.scss";
...
function ChatLayout({ children }) {
  ...
  return (
    <>
      <Header />
      <div className={Styles.chats__container__wrappers}>
        <div className={Styles.chats__container__middle_wrappers}>
